...
from modules.server_monitor.config import COMMON_PORTS, REQUEST_TIMEOUT
...
from modules.server_monitor.monitor.dns_monitor import resolve_domain
from modules.server_monitor.monitor.phase3_domain_discovery import (
    normalize_hostname,
